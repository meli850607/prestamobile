<?php /* Smarty version Smarty-3.1.19, created on 2018-06-19 15:10:07
         compiled from "/home/lr26/prestashop-1.7.3.3-0/apps/prestashop/htdocs/administration/themes/default/template/controllers/groups/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3699602845b2900afe444c5-68404970%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '92b9b6ac9742fbb42bc648a3ed6c08f7ec5c104c' => 
    array (
      0 => '/home/lr26/prestashop-1.7.3.3-0/apps/prestashop/htdocs/administration/themes/default/template/controllers/groups/helpers/form/form.tpl',
      1 => 1527176670,
      2 => 'file',
    ),
    '8ee82171b2a60b7e1a3d3aad4fe8a9227511d551' => 
    array (
      0 => '/home/lr26/prestashop-1.7.3.3-0/apps/prestashop/htdocs/administration/themes/default/template/helpers/form/form.tpl',
      1 => 1527176670,
      2 => 'file',
    ),
    '744c70c08242174cc764dd10cf1d63c4828b12d6' => 
    array (
      0 => '/home/lr26/prestashop-1.7.3.3-0/apps/prestashop/htdocs/administration/themes/default/template/helpers/form/form_group.tpl',
      1 => 1527176670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3699602845b2900afe444c5-68404970',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b2900b0305691_16867265',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b2900b0305691_16867265')) {function content_5b2900b0305691_16867265($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/lr26/prestashop-1.7.3.3-0/apps/prestashop/htdocs/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
" />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='modules') {?>
		<div <?php if (!$_smarty_tpl->tpl_vars['form_id']->value) {?>class="hide"<?php }?>>
			<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Authorized modules:','d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl);?>
</label>
		</div>
	...
	<div <?php if (!$_smarty_tpl->tpl_vars['form_id']->value) {?>class="hide"<?php }?>>
		...
		function addCategoryReduction()
		{
			...
			$('.category_reduction').each( function () {
				...
				{
					exist = true;
					jAlert('<?php echo smartyTranslate(array('s'=>'This category already exists for this group.','js'=>1,'d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl);?>
');
					return false;
				}
			});
...
",
				...
				success : function(jsonData) {
					...
					{
						$('#group_discount_category_table').append('<tr class="alt_row" id="'+jsonData.id_category+'"><td>'+jsonData.catPath+'</td><td><?php echo smartyTranslate(array('s'=>'Discount','d'=>'Admin.Global'),$_smarty_tpl);?>
' + ' ' + jsonData.discount+'<?php echo smartyTranslate(array('s'=>'%'),$_smarty_tpl);?>
</td><td><a href="#" onclick="deleteCategoryReduction('+jsonData.id_category+');" class="btn btn-default"><i class="icon-trash"></i> <?php echo smartyTranslate(array('s'=>'Delete','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a></td></tr>');
		...
		<div class="col-lg-9">
			<a class="btn btn-default" href="#group_discount_category_fancybox" id="group_discount_category"><?php echo smartyTranslate(array('s'=>'Add a category discount','d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl);?>
</a>
...
">
		...
		<div id="group_discount_category_fancybox" class="bootstrap" style="display:none" >
			<div class="panel">
				<div class="panel-heading">
					<i class="icon-group"></i> <?php echo smartyTranslate(array('s'=>'New group category discount','d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl);?>

				</div>
				<?php echo $_smarty_tpl->tpl_vars['categoryTreeView']->value;?>

				<div class="form-horizontal">
				<div class="alert alert-info"><?php echo smartyTranslate(array('s'=>'Caution: The discount applied to a category does not stack with the overall reduction but instead replaces it.','d'=>'Admin.Shopparameters.Notification'),$_smarty_tpl);?>
</div>
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Only products that have this category as the default category will be affected.','d'=>'Admin.Shopparameters.Notification'),$_smarty_tpl);?>
</div>
				<div class="form-group">
					<label class="control-label col-lg-3" for="category_reduction_fancybox"><?php echo smartyTranslate(array('s'=>'Discount (%):','d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl);?>
</label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					<div class="col-lg-12">
						<button type="button" onclick="addCategoryReduction();" class="btn btn-default pull-right"><?php echo smartyTranslate(array('s'=>'Add','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
					</div>
				</div>
			</div>
...
?>
			<div class="form-group">
				<label class="control-label col-lg-4"><img src="../modules/<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['module']->value->name,'html','UTF-8');?>
/logo.png" height="16" width="16" alt="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['module']->value->displayName,'html','UTF-8');?>
" /> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['module']->value->displayName,'html','UTF-8');?>
				...
				<div class="input-group col-lg-8">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['module']->value->name,'html','UTF-8');?>
" id="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['module']->value->name,'html','UTF-8');?>
_on" value="1" checked="checked"/>
						<label for="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['module']->value->name,'html','UTF-8');?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '3699602845b2900afe444c5-68404970');
content_5b2900b01e0525_15155907($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-06-19 15:10:08
         compiled from "/home/lr26/prestashop-1.7.3.3-0/apps/prestashop/htdocs/administration/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5b2900b01e0525_15155907')) {function content_5b2900b01e0525_15155907($_smarty_tpl) {?>
